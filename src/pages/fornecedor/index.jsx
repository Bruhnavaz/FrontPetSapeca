        ...
        <header className="header-admin">
          <nav>
            <ul>
              ...
              <li>
                <a className="page-admin" href="/fornecedor">
                  FORNECEDORES
                </a>
              </li>
              <li>
          ...
          <div className="fornecedores">
            <div className="board-fornecedores">
              ...
              <ul className="lista-fornecedor">
                <li>
                  <p>123.123.123/0001 </p>,<p>Mars S.A </p>,
                  <p>(11) 1234-5678 </p>,<p>contato@mars.com.br </p>
                </li>
              </ul>
            </div>
          </div>
